...
import ratpack.example.java.SmartAppGetHandler;
import ratpack.example.java.SmartAppPostHandler;
		  ...
		  EmbeddedApp.of(s-> s
				  .serverConfig(c -> c.baseDir(BaseDir.find()))
			        ...
			        .handlers(chain -> chain
			        	.get("switches",SmartAppGetHandler.class)
			        	.post("setLevel", SmartAppPostHandler.class)
